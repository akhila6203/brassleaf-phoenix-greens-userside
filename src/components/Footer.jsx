export default function Footer() {
  return (
    <footer className="w-full border-t border-[#D9A537]/30 bg-[#1E2E3E]">
      <div className="container-site flex min-h-[84px] items-center justify-center px-4 py-5">
        <p className="text-center text-[13px] font-normal text-slate-300 sm:text-sm">
          Copyright © 2026{" "}
          <span className="font-bold text-[#D9A537]">
            BrassLeaf.
          </span>{" "}
          All Rights Reserved.
        </p>
